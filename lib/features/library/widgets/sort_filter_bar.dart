            ...
            children: [
              ...
              _FilterChip(
                ...
                onSelected: (v) => bloc.add(
                  LibraryFormatFilterChanged(v ? 'epub' : null),
                ),
              ),
              ...
              _FilterChip(
                ...
                onSelected: (v) => bloc.add(
                  LibraryFormatFilterChanged(v ? 'pdf' : null),
                ),
              ),
              const SizedBox(width: 4),
              _FilterChip(
                ...
                onSelected: (v) => bloc.add(
                  LibraryFormatFilterChanged(v ? 'cbz' : null),
                ),
              ),
              const SizedBox(width: 8),
              // Status filter chips
              _FilterChip(
                ...
                onSelected: (v) => bloc.add(
                  LibraryStatusFilterChanged(v ? 'unread' : null),
                ),
              ),
              const SizedBox(width: 4),
              _FilterChip(
                ...
                onSelected: (v) => bloc.add(
                  LibraryStatusFilterChanged(v ? 'reading' : null),
                ),
              ),
              const SizedBox(width: 4),
              _FilterChip(
                ...
                onSelected: (v) => bloc.add(
                  LibraryStatusFilterChanged(v ? 'read' : null),
                ),
              ),
              const SizedBox(width: 8),
              // Favorites
              _FilterChip(
                ...
                onSelected: (_) =>
                    bloc.add(LibraryFavoritesFilterToggled()),
              ),
            ],
          ),
        );
